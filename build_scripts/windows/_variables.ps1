...
Set-Variable -Name PROJECT_NAME -Value "cpp-win32-template"
Set-Variable -Name EXE_NAME -Value "cpp-win32-template_Debug.exe"
...
$temp = Resolve-Path -Path $BUILD_SCRIPTS_DIR_PATH\$PROJECT_ROOT_PATH_RELATIVE_FROM_SCRIPT
Set-Variable -Name PROJECT_ROOT_DIR_PATH -Value $temp
